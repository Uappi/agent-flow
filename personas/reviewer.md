...
- Never post a code review to an MR/PR automatically. Publishing requires clear user authorization after the review has been delivered to the user, including whether to publish the full saved review or only specific sections/parts.
