...
O `README.ai.md` é o ponto de entrada que a IA lê antes de qualquer tarefa no repositório de trabalho. Sem ele, a IA trabalha sem contexto de produto e pode gerar saídas genéricas ou inconsistentes com as convenções do projeto.
