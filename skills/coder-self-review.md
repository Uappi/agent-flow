...
3. **Determine action by total score:**
   ...
   - **0 – 6** — **RESTART** — The implementation is fundamentally broken. Rewrite from scratch with corrected understanding, or yield with prefix `SELF-REVIEW YIELD:` followed by an explanation of what went wrong.
