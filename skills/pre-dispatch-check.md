...
| `Análise suporte`, `Análise N2`, `Triagem N2`, `Diagnóstico N2`, `Documentação Analise inicial` | support task URL |
| `RCA suporte`, `RCA N2`, `Análise profunda suporte`, `Causa raiz suporte` | support task URL |
| All other flows | — |
...
| `Análise suporte`, `Análise N2`, `Triagem N2`, `Diagnóstico N2`, `Documentação Analise inicial` | support task URL |
| `RCA suporte`, `RCA N2`, `Análise profunda suporte`, `Causa raiz suporte` | support task URL, MR/PR URL (if supplied), release URL (if supplied) |
| All other flows | — |
