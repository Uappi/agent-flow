...
| Uappi v3 — backend | `ext/uappi-v3/backend/` | Core (qualquer sinal, todos backend): A — `grep -q "Uappi V3" README.ai.md` · B — dir `*.uappi` presente · C — dir `apis/api.uappi.com.br` presente. |
